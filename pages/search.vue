  ...
  <div>  
    <form class="max-w-md mx-auto">   
        ...
        <div class="relative">
            ...
            <input v-model="searchTerm" type="text" id="default-search" class="searchbar" placeholder="Search Movies, Series" required />
            <button type="submit" class="text-white absolute end-2.5 bottom-2.5 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Search</button>
        </div>
    </form>

    <section>
      <h2 v-if="movies.length" class="text-2xl font-bold text-gray-900 dark:text-white">Movie Results</h2>
    ...
    <section>
      <h2 v-if="series.length" class="text-2xl font-bold text-gray-900 dark:text-white">Series Results</h2>
      <div class="grid grid-cols-1 gap-4 mt-4 sm:grid-cols-2 lg:grid-cols-3">
